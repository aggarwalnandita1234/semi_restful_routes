...
"""
routes['default_controller'] = 'Semis'
routes['POST']['/create']='Semis#create'
routes['GET']['/show/<id>']='Semis#show'
routes['GET']['/edit/<id>']='Semis#edit'
routes['POST']['/update']='Semis#update'
routes['GET']['/destroy/<id>']='Semis#destroy'
"""
